 ...
 */
class Aportes extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idAporte, descripcionAporte', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'convenioAportes' => array(self::HAS_MANY, 'ConvenioAportes', 'aportes_idAporte'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'idAporte' => 'Id Aporte',
			'descripcionAporte' => 'Descripcion Aporte',
		);
	}
	 ...
	 * @return Aportes the static model class
	 */
