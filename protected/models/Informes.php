...
class Informes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idInforme, convenios_idConvenio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'convenioCriterioses' => array(self::HAS_MANY, 'ConvenioCriterios', 'informes_idInforme'),
	...
	public function search()
	{
		...
		$criteria->compare('idInforme',$this->idInforme);
