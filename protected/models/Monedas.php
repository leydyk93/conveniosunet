 ...
 * @property string $descripcionMoneda
 *
...
class Monedas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idMoneda, descripcionMoneda', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'convenioAportes' => array(self::HAS_MANY, 'ConvenioAportes', 'monedas_idMoneda'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'idMoneda' => 'Id Moneda',
			'descripcionMoneda' => 'Descripcion Moneda',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('descripcionMoneda',$this->descripcionMoneda,true);
