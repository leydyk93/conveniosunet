...
class ConvenioEstados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_convenio_estado, convenios_idConvenio, estadoConvenios_idEstadoConvenio, fechaCambioEstado', 'required'),
			array('id_convenio_estado, estadoConvenios_idEstadoConvenio, numeroReporte, dependencias_idDependencia', 'length', 'max'=>10),
	...
	public function search()
	{
		...
		$criteria->compare('id_convenio_estado',$this->id_convenio_estado,true);
		$criteria->compare('convenios_idConvenio',$this->convenios_idConvenio,true);
		$criteria->compare('estadoConvenios_idEstadoConvenio',$this->estadoConvenios_idEstadoConvenio,true);
