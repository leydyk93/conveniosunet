 ...
 */
class Tiposinstituciones extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idTipoInstitucion, nombreTipoInstitucion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'instituciones' => array(self::HAS_MANY, 'Instituciones', 'tiposInstituciones_idTipoInstitucion'),
		);
	}
	 ...
	 * @return Tiposinstituciones the static model class
	 */
