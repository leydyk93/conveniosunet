       ...
       <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <th><a href="<?php echo $this->createUrl("/convenios/eliminarEstado",array('id'=>$value->id_convenio_estado)); ?>" onclick='return confirm("Esta seguro de eliminar el estado");' data-toggle='tooltip' title='Eliminar'><span class='glyphicon glyphicon-trash'></span></a></th>
            </tr>
            </tr>
            <?php } ?>
          </tbody>
                            ...
                            <div class="col-md-7">
                             ...
                             /*$list2=CHtml::listData($modelDpcia,'idDependencia', 'nombreDependencia');
                                 echo $form->dropDownList($modeloE,'dependencias_idDependencia', 
                                      $list2,array('class'=>"form-control input-sm"));*/
