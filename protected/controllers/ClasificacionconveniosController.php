...
class ClasificacionconveniosController extends Controller
{
	/**
	...
	{
		$model=new Clasificacionconvenios;
	...
	{
		$dataProvider=new CActiveDataProvider('Clasificacionconvenios');
	...
	{
		$model=new Clasificacionconvenios('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Clasificacionconvenios']))
			$model->attributes=$_GET['Clasificacionconvenios'];
	 ...
	 * @return Clasificacionconvenios the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Clasificacionconvenios::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Clasificacionconvenios $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='clasificacionconvenios-form')
		{
