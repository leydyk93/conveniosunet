...
class TipoconveniosController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Tipoconvenios');
	...
	{
		$model=new Tipoconvenios('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tipoconvenios']))
			$model->attributes=$_GET['Tipoconvenios'];
	 ...
	 * @return Tipoconvenios the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Tipoconvenios::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Tipoconvenios $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipoconvenios-form')
		{
